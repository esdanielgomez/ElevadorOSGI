...
@Component
public class Elevador2 implements IElevador2 {

	public Elevador2() {
		this.setIdElevador(Informacion.IdElevador2);
        this.setNombreElevador(Informacion.NombreElevador2);
        this.setPisoDefectoElevador(Informacion.PisoDefectoElevador2);
        this.setPisoActualElevador(Informacion.PisoDefectoElevador2);
